'''
Used the python implementation of stable marriage problem from https://www.vitoshacademy.com/python-algorithms-stable-matching-problem/
Only modified males to represent doodles and females to represent images.
'''
'''
Old data
males = [
...
parser.add_argument('--features_fname', default='svm_1d_1i_5cat_marriage.py.npy')
args = parser.parse_args()

infname = GRAPH_FEATURES + args.features_fname
edges_info = np.load(infname, allow_pickle=True).item()
males = edges_info['male (doodle)']
females = edges_info['female (image)']
